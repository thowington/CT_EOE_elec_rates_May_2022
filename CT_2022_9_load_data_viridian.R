...
# read raw data
viridian <- read_excel("C:/Users/thowi/Documents/consulting_work/CT_EOE_elec_rates_May_2022/from_EOE/# Summarized EOE-6 Supplier Data/Supplier Summized Data - 2.xlsx",
                     sheet = "Viridian",
                     skip = 0,
                     col_names = TRUE)
str(viridian)
