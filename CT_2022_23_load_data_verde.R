...
# read raw data
verde <- read_excel("C:/Users/thowi/Documents/consulting_work/CT_EOE_elec_rates_May_2022/from_EOE/# Summarized EOE-6 Supplier Data/Supplier Summized Data - 5.xlsx",
                     sheet = "Verde",
                     skip = 0,
                     col_names = TRUE)
str(verde)
