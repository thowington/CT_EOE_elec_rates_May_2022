...
# read raw data
energyplus <- read_excel("C:/Users/thowi/Documents/consulting_work/CT_EOE_elec_rates_May_2022/from_EOE/# Summarized EOE-6 Supplier Data/Supplier Summized Data - 4.xlsx",
                     sheet = "Energy Plus",
                     skip = 0,
                     col_names = TRUE)
str(energyplus)
